  ...
  useEffect(() => {
    ...
    let projectInterval = setInterval(() => {
      setProjectsCount((prev) =>
        prev < targetProjects ? prev + 1 : targetProjects
      );
    }, 100);
        ...
        <div className="col-span-2 grid grid-rows-2 gap-8 ">
          ...
          >
            ...
            <p className="text-xl leading-relaxed text-gray-700 text-justify">
              Hi, I'm{" "}
              <span className="font-semibold text-indigo-600">Ryan</span>! An
              aspiring Business Analyst who indulges in problem solving and
              loves exploring new things! I'm also an avid athlete, playing
              Ultimate Frisbee and Football. Feel free to connect via my
              socials! Always excited to meet new people 😆
            </p>
          </motion.div>
