  ...
  return (
    ...
    >
      ...
      <div className="lg:w-1/2 flex flex-col items-center text-center lg:text-left px-4 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="text-lg md:text-2xl lg:text-3xl mt-4 mb-6 text-indigo-500 font-semibold">
            Aspiring <span className="text-indigo-700">{currentText}</span>
      ...
      <div className="lg:w-1/2 flex justify-center items-center px-4 md:px-8 l:pt-0 pb-10">
        <motion.div
          className="relative w-40 h-58 md:w-56 md:h-80 lg:w-80 lg:h-[570px] xl:w-96 xl:h-[690px] flex self-center"
          whileHover={{ y: -3 }}
        >
          {/* Gradient Rectangle */}
